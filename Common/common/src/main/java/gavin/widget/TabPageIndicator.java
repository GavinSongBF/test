...
//        final TabView tabView = (TabView)inflater.inflate(R.layout.item, null);
    ...
    private class TabView extends TextView {
        ...
        {
            super(context, null);
            setTextAppearance(context, R.style.viewPagerIndicatorTextStyle);
            setSingleLine(true);
            setMaxLines(1);
            setBackgroundResource(R.drawable.view_pager_tab_indicator);

            //最宽6个汉字
            int maxWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 112, getResources().getDisplayMetrics());
