...
public class CircleImageViewNormal extends ImageView {
	...
	public CircleImageViewNormal(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public CircleImageViewNormal(Context context) {
		super(context);
		init(context);
	}
